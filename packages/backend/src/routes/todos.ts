...
router.post('/', validate(CreateTodoSchema), asyncHandler(async (req: AuthRequest, res) => {
...
router.put('/:id', validate(UpdateTodoSchema), asyncHandler(async (req: AuthRequest, res) => {
...
router.patch('/:id/toggle', asyncHandler(async (req: AuthRequest, res) => {
