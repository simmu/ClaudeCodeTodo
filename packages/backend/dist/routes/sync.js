...
router.post('/', validate(SyncPayloadSchema), asyncHandler(async (req, res) => {
...
router.post('/resolve-conflict', validate(ConflictResolutionSchema), asyncHandler(async (req, res) => {
